...
public class CustomerOrderService {
    ...
    public Map<String, Object> queryOrdersByCid(CustomerOrderQuery customerOrderQuery) {
        ...
        List<CustomerOrder> customerOrderList = customerOrderDao.queryOrdersByCid(customerOrderQuery.getCid());
    ...
    public Map<String, Object> queryOrderInfoById(Integer orderId) {
        Map<String,Object> map = customerOrderDao.queryOrderInfoById(orderId);
        return map;
    }
}
